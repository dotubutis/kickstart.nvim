...
vim.keymap.set('i', '<left>', '<cmd>echo "Arrow keys are disabled in insert mode"<CR>')
vim.keymap.set('i', '<right>', '<cmd>echo "Arrow keys are disabled in insert mode"<CR>')
vim.keymap.set('i', '<up>', '<cmd>echo "Arrow keys are disabled in insert mode"<CR>')
vim.keymap.set('i', '<down>', '<cmd>echo "Arrow keys are disabled in insert mode"<CR>')
